...
export class MyOrderService {
  ...
  public getAllByStatus(status: number): Observable<MyOrder[]> {
    return this.httpClient.get<MyOrder[]>(`${this.baseUrl}/getAllByStatus/${status.toString()}`);
  }

  public getAllByRider(riderId: number): Observable<MyOrder[]> {
    return this.httpClient.get<MyOrder[]>(`${this.baseUrl}/getAllByRider/${riderId.toString()}`);
  }
