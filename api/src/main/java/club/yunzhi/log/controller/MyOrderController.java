...
public class MyOrderController {
    ...
    @GetMapping("getAllByRider/{id}")
    public List<MyOrder> getAllByRider(@PathVariable Long id) {
        return this.orderService.getAllByRiderId(id);
    }

    @GetMapping("getAllByStatus/{status}")
    public List<MyOrder> getAllByStatus(@PathVariable Long status) {
